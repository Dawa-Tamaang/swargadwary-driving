...
const Home = () => {
  return (
    <>
      ...
      <div className="content py-8 px-4 sm:px-8 md:px-16 lg:px-28">
        <h3 className="sm:text-5xl font-bold font-serif text-center pt-4 sm:pt-8 pb-5">
          WHY CHOOSE US?
        </h3>
      ...
      <div>
        <h3 className="md:text-5xl sm:text-xl font-bold font-serif text-center sm:pt-14 pt-4 pb-5">
          ...
          {links.map((link, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <a href={link.links} className="bg-blue-500 text-white font-bold py-2 px-4 my-4 rounded hover:bg-blue-700">
                  Clink Here
                </a>
